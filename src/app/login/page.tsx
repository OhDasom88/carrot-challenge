...
export default function LogIn() {
    ...
    return (
        ...
        <form action={trigger} className="flex flex-col gap-3 w-3/4 max-w-md">
            ...
            <FormInput 
            name="username" type="text" placeholder="Username" defaultValue={state?.formData?.get("username") ?? ""} required 
            errors={[state?.errors?.get("username") ?? []]}
            icon={
            ...
            required
            errors={state?.errors?.get("password") ?? []}
            icon={
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
        ...
        {
            state?.errors?.size === 0 && (
            <div className="flex items-center gap-2 mt-4 p-3 bg-green-400 rounded-md w-3/4 max-w-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
